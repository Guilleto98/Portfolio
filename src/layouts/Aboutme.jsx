    ...
    <>
      <div className="flex flex-wrap items-center justify-center h-screen w-full">
        ...
        <div className="w-full h-full  md:w-1/2 bg-gray-700 flex items-center justify-center">
          ...
          <p className="p-Aboutme text-2xl font-serif text-center md:text-left px-10 py-20">
            I am a dedicated front-end developer with experience in React. I am
            ...
            During my education, I discovered my enthusiasm for programming and
            have since been focused on Front-end development with React.js.
            <br />
            <br />
